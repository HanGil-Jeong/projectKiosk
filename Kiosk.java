...
public class Kiosk {
    ...
    public Kiosk(){
        ...
        for(MenuItem menuItem : menuList){ // for문을 활용하여 리스트 조회
            //리스트 속성 출력
            System.out.println(selectNumber + ". " + menuItem.foodName + " | W " + menuItem.price + " | " + menuItem.foodIntro);
            selectNumber++;
        }
    ...
    public Kiosk(String choiceNumber) {
        switch (choiceNumber) {
            ...
            case "0":
                ...
                break;
            default:
                System.out.println("잘못 누르셨습니다."); // 선택가능한 숫자 외 다른값 입력 시 경고문 출력
                System.out.println("");
